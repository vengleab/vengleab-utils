      ...
      <Layout title="String Length">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <div className="mb-6 lg:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">String Length</h1>
            <p className="mt-2 text-sm sm:text-base text-slate-500">Calculate the length of your text string in real-time.</p>
          </div>
