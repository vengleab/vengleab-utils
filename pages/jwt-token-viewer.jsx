      ...
      <Layout title="JWT Token Viewer">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <div className="mb-6 lg:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">JWT Token Viewer</h1>
            <p className="mt-2 text-sm sm:text-base text-slate-500">Decode and inspect JSON Web Tokens (JWT) easily.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-6 lg:p-7 relative overflow-hidden space-y-6">
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold text-slate-800 mb-3 block">Input JWT Token</label>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {header ? (
                    <div className="custom-scrollbar overflow-auto">
                     ...
                     <div className="p-5 font-mono text-sm text-slate-500 flex items-center justify-center h-full min-h-[200px]">
                        <span className="italic opacity-50">Waiting for valid token...</span>
                     </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                   ...
                   <label className="text-sm font-semibold text-slate-800">Payload</label>
                </div>
                <div className="bg-[#1e1e1e] rounded-xl shadow-inner border border-[#2d2d2d] overflow-hidden min-h-[200px] p-5">
                  {payload ? (
                    <div className="custom-scrollbar overflow-auto">
